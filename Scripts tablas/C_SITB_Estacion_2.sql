...
/****** Object:  Table [dbo].[SITB_Estacion_2]    Script Date: 27/12/2023 10:17:17 a. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[SITB_Estacion_2](
	[Est2_Id] [int] IDENTITY(1,1) NOT NULL,
	[Est_Id] [varchar](50) NULL,
	[Est2_Fecha] [varchar](50) NULL,
