    ...
    datasets: [
        {
            ...
            data: [-0.5, -0.5, -0.6, -0.3, -0.4, -0.3, -0.3, -0.4, -0.3, -0.2, -0.2, -0.3]
        },
        {
            label: "El Niño",
            ...
            data: [0.7, 0.8, 0.8, 0.5, 0.2, 0.3, 0.3, 0.3, 0.4, 0.2, 0.2, 0.4]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [-0.8, -0.7, -0.8, -0.5, -0.5, -0.4, -0.4, -0.5, -0.5, -0.1, -0.3, -0.5]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [1.0, 1.3, 1.1, 0.7, 0.2, 0.4, 0.2, 0.4, 0.6, 0.5, 0.4, 0.7]
        }
    ]
}
...
var datosPrecipitacionMensual = {
    ...
    datasets: [
        {
            label: "Valle del Magdalena y zonas bajas de la Cordillera Central",
            fillColor: "rgba(85,135,193,0.6)",
            strokeColor: "rgba(85,135,193,0.8)",
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [81.1, 103.6, 140.4, 216.5, 194.0, 90.2, 64.6, 73.4, 136.2, 201.5, 171.2, 117.3]
        },
        {
            label: "Vertientes de las Cordilleras Oriental y Central",
            fillColor: "rgba(196,86,83,0.6)",
            strokeColor: "rgba(196,86,83,0.8)",
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [113.3, 129.8, 173.6, 208.9, 172.0, 86.8, 66.3, 59.9, 103.9, 224.1, 235.4, 163.7]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            data: [123.7, 116.7, 125.8, 115.4, 117.5, 117.1, 130.9, 141.6, 133.8, 122.4, 107.9, 112.7]
        },
        {
            label: "PPT",
            ...
            data: [95.8, 115.5, 155.5, 212.9, 184.6, 90.7, 67.6, 68.7, 121.7, 211.6, 200.7, 138.5]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [7, 18, 5, -3, -5, 47, 48, 57, 11, 5, 9, 21]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [-19, -23, -15, 10, 2, -20, -19, -41, -8, -2, -7, -10]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [6, 26, 24, 5, 2, 26, 47, 46, 21, 8, 16, 26]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [-32, -26, -16, 8, -5, -25, -18, -38, -16, 0, -15, -23]
        }
    ]
}
