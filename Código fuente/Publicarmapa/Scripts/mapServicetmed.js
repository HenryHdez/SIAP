...
var url_to_geotiff_file = [{ name: "CP01", url: '../Content/imagenes/Temperatura_media/TMED_01_ENE_geo.tif', index: 1, noData: -3.4028234663852886e+38 },
                           { name: "CP02", url: '../Content/imagenes/Temperatura_media/TMED_02_FEB_geo.tif', index: 2, noData: -3.4028234663852886e+38 },
                           { name: "CP03", url: '../Content/imagenes/Temperatura_media/TMED_03_MAR_geo.tif', index: 3, noData: -3.4028234663852886e+38 },
                           { name: "CP04", url: '../Content/imagenes/Temperatura_media/TMED_04_ABR_geo.tif', index: 4, noData: -3.4028234663852886e+38 },
                           { name: "CP05", url: '../Content/imagenes/Temperatura_media/TMED_05_MAY_geo.tif', index: 5, noData: -3.4028234663852886e+38 },
                           { name: "CP06", url: '../Content/imagenes/Temperatura_media/TMED_06_JUN_geo.tif', index: 6, noData: -3.4028234663852886e+38 },
                           { name: "CP07", url: '../Content/imagenes/Temperatura_media/TMED_07_JUL_geo.tif', index: 7, noData: -3.4028234663852886e+38 },
                           { name: "CP08", url: '../Content/imagenes/Temperatura_media/TMED_08_AGO_geo.tif', index: 8, noData: -3.4028234663852886e+38 },
                           { name: "CP09", url: '../Content/imagenes/Temperatura_media/TMED_09_SEP_geo.tif', index: 9, noData: -3.4028234663852886e+38 },
                           { name: "CP10", url: '../Content/imagenes/Temperatura_media/TMED_10_OCT_geo.tif', index: 10, noData: -3.4028234663852886e+38 },
                           { name: "CP11", url: '../Content/imagenes/Temperatura_media/TMED_11_NOV_geo.tif', index: 11, noData: -3.4028234663852886e+38 },
                           { name: "CP12", url: '../Content/imagenes/Temperatura_media/TMED_12_DIC_geo.tif', index: 12, noData: -3.4028234663852886e+38 },
                           { name: "CP13", url: '../Content/imagenes/Temperatura_media/TMED_13_DEF_geo.tif', index: 13, noData: -3.4028234663852886e+38 },
                           { name: "CP14", url: '../Content/imagenes/Temperatura_media/TMED_14_MAM_geo.tif', index: 14, noData: -3.4028234663852886e+38 },
                           { name: "CP15", url: '../Content/imagenes/Temperatura_media/TMED_15_JJA_geo.tif', index: 15, noData: -3.4028234663852886e+38 },
                           { name: "CP16", url: '../Content/imagenes/Temperatura_media/TMED_16_SON_geo.tif', index: 16, noData: -3.4028234663852886e+38 },
                           { name: "CP17", url: '../Content/imagenes/Temperatura_media/TMED_17_ANU_geo.tif', index: 17, noData: -3.4028234663852886e+38 },
...
function leyenda(op) {
    legend1.onAdd = function (map) {
        ...
        div.innerHTML = '<div style = "font-size: 12px;background-color: rgb(255, 255,255); width:140px; font-size: 14px;"><b>Leyenda <br><i>°C</i></b></div>'+
                        '<div style="display: flex;"><div style="background-color: rgb(0,114,6); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;"> &#60; 6</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(126,185,16); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">6 - 8</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(185,220,28); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">8 - 10</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(242,254,30); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">10 - 12</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(255,171,18); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">12 - 14</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(254,123,10); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">14 - 16</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(254,95,14); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">16 - 18</div></div>' +
                        '<div style="display: flex;"><div style="background-color: rgb(252,59,9); width: 20px; height: 20px;"></div> <div style = "font-size: 12px;background-color: rgb(255, 255,255); width:120px;">&#62; 18</div></div>';
        return div;
    };
    legend1.addTo(map);
}
    ...
    function convertToRgb(pixelValue) {
        ...
        if (data.name != "CP1A") {
            if (pixelValue > -100) {
                ...
                else if (pixelValue >= 10 && pixelValue < 12) {
                    red = 242;
                    green = 254;
                    blue = 30;
                }
                else if (pixelValue >= 12 && pixelValue < 14) {
                    red = 255;
                    green = 171;
                    blue = 18;
                }
