...
function Ocultar_car_sul(){
    ...
    if (os == 0) {
        document.getElementById("Car_sul_tab1").style.display='none';
        document.getElementById("Car_sul_tab2").style.visibility ='hidden';
        document.getElementById("Car_sul_tab3").style.visibility ='hidden';
    }
    else{
        document.getElementById("Car_sul_tab1").style.display='block';
        document.getElementById("Car_sul_tab2").style.visibility ='visible';
        document.getElementById("Car_sul_tab3").style.visibility ='visible';
    }
}
...
function Leer_csv(Estado_Cal) {
    ...
    try {
        ...
        //let L_json = Estjson.Fecha1.length;//Object.keys(Est[0][Fech]).length;
        //console.log(L_json)
        //Extraer del json
        ...
        let Kcini = 0.86;//parseFloat(document.getElementById("Kco").value); // 0.86; //Coeficientes del cultivo por etapas
        let Kcmed = 1.07;//parseFloat(document.getElementById("Kcm").value); // 1.07;
        let Kcfin = 0.67;//parseFloat(document.getElementById("Kcf").value); // 0.67;
        ...
        let pini = 0.35;//parseFloat(document.getElementById("Fa1").value); //0.35; //Factor de agotamiento (-)
        let pdes = 0.35;//parseFloat(document.getElementById("Fa1").value); //
        ...
        const fechaver1 = esDiaDeHoyDespuesSumarDias(longitud, Fecha_siem_1);
        //console.log(fechaver1)
        if(fechaver1){
