    ...
    datasets: [
        {
            ...
            data: [-0.3, -0.3, -0.3, -0.3, -0.4, -0.2, -0.1, -0.1, 0.0, -0.1, 0.0, -0.2]
        },
        {
            label: "El Niño",
            ...
            data: [0.4, 0.5, 0.5, 0.5, 0.1, 0.1, 0.2, 0.2, 0.2, 0.1, 0.1, 0.3]
        }
    ]
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [-0.7, -0.5, -0.5, -0.3, -0.3, -0.5, -0.4, -0.6, -0.2, -0.2, -0.4, -0.5]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [0.9, 0.8, 0.8, 0.7, 0.4, 0.4, 0.4, 0.6, 0.3, 0.3, 0.5, 0.6]
        }
    ]
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [369.7, 312.3, 338.7, 471.9, 548.8, 501.2, 530.2, 547.6, 518.1, 521.1, 524.3, 462.9]
        },
        {
            label: "Cluster 2",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [162.9, 148.9, 182.9, 273.2, 310.3, 255.5, 247.9, 253.4, 281.2, 327.8, 299.7, 218.5]
        }
    ]
}

var datosPrecipitacionPeriodica = {
    labels: ["EFM", "AMJ", "JAS", "OND"],
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [1020.7, 1522.0, 1595.9, 1508.3]
        },
        {
    ...
    datasets: [
        {
            ...
            data: [88.4, 86.4, 98.4, 93.2, 95.0, 90.3, 98.0, 101.0, 94.2, 92.1, 84.0, 83.7]
        },
        {
            label: "PPT",
            ...
            data: [266.3, 230.6, 260.8, 372.6, 429.6, 378.4, 389.0, 400.5, 399.7, 424.4, 412.0, 340.7]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [23, 18, 12, 0, -1, 2, 5, 9, 3, 6, 13, 17]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [-28, -25, -14, -8, -7, -9, 2, -4, -3, -10, -11, -18]
        }
    ]
}
    ...
    datasets: [
        {
            ...
            highlightFill: "rgba(85,135,193,0.75)",
            highlightStroke: "rgba(85,135,193,1)",
            data: [25, 25, 17, 4, -1, 13, 14, 22, 8, 10, 17, 24]
        },
        {
            label: "El Niño",
            fillColor: "rgba(196,86,83,0.6)",
            ...
            highlightFill: "rgba(196,86,83,0.75)",
            highlightStroke: "rgba(196,86,83,1)",
            data: [-32, -24, -15, -10, -9, -17, -9, -20, -8, -9, -13, -27]
        }
    ]
}
